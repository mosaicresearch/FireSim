#ifndef CLICK_INFOPAINTER_HH
#define CLICK_INFOPAINTER_HH
#include <click/element.hh>
#include <click/string.hh>
CLICK_DECLS

class InfoPainter : public Element { public:
     ...
     */
    const char *class_name() const		{ return "InfoPainter"; }
